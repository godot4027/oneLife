...
private Properties query = new Properties();
	...
	public int adminGetListCount(Connection conn, VisitCarSearch vs) {
		...
		if(vs.getDong() != null && vs.getHo() != null && vs.getCarNo() != null && vs.getDate() != null && vs.getStatus() != null) {
			//동
	...
	public List<VisitCar> adminSelectList(Connection conn, PageInfo pi, VisitCarSearch vs) {
		...
		try {
			...
			while(rset.next()) {
				visitCarList.add(new VisitCar(rset.getInt("vc_id"), rset.getDate("vc_date"), rset.getString("vc_no"),
						rset.getString("vc_purpose"), rset.getString("vc_phone"), rset.getDate("vc_modifydate"), rset.getString("vc_status"), rset.getString("r_name"), rset.getInt("r_dong"), rset.getInt("r_ho"), rset.getInt("u_no"), rset.getString("m_name")));
			}
