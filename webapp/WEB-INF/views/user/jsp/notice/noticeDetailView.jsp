	...
	<div class="bottom_wrap1">
					...
					<div class="btn_area">
						...
						<c:choose>
						 <c:when test="${check eq 0}">
						 	<button type="button" id="weekInsertBtn">주요일정 등록</button>
						 </c:when>
						 <c:otherwise>
			     ...
			     <form name="weekFrm">
	                        <div class="view_items">
	                            ...
	                            <dl class="items">
	                                ...
	                                <dd>    
	                                    <div class="calendar">
	                                    	<c:set var="now" value="<%=new java.util.Date()%>" />
											<c:set var="sysDate"><fmt:formatDate value="${now}" pattern="yyyy-MM-dd"/></c:set>
					                    	<input id="modalChangeDate" type="text" name="searchDay" class="cal_today" value="${sysDate}">
					                    	<p id="modalP"> ~ </p>  
			                    			<input id="modalChangeDate2" type="text" name="searchDay" class="cal_today">
			                    			<input type="checkbox" id="modalChangeCheck" ><label for="modalCheck">기간 설정</label>
	                            ...
	                            <dl class="items">
	                                ...
	                                <dd>
	                                   <div class="input">
				                    			<input id="modalChangeTitle" type="text" name="scTitle" value="${ notice.n_title }">
	                                   </div>
	                                </dd>
	                            </dl>
	                            ...
	                            <dl class="items">
	                                ...
	                                <dd>
	                                   <div class="textarea">
					                    	<textarea name="scContent" id="modalChangeTextarea" cols="30" rows="10">${fn:substring(notice.n_content, 3, fn:length(notice.n_content)-4)}</textarea>
	                                   </div>
	                                </dd>
	                            </dl>
	                        </div>
	                        <div class="modalBtnDiv">
	                        <button class="modalBtn" type="button" onclick="">변경하기</button>
	                        <button class="modalBtn" type="button" onclick="">삭제하기</button>
		...
		<script>
			...
			function weekUPInsert() {
				...
				let content = $('#modalTextarea').text();
				...
				$.ajax({
					...
					type : "post",
					data : {type : type, title : title, content : content, date1 : date1, date2 : date2, nno : nno},				
					dataType : "json",
